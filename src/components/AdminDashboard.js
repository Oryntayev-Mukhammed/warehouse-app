  ...
  return (
    ...
    <ul id="slide-out" class="side-nav fixed z-depth-2">
        ...
        <div class="indigo darken-2 white-text" style={{height: '180px'}}>
            <div class="row">
            <img style={{ marginTop: '5%' }} width="100" height="100" src="https://res.cloudinary.com/dacg0wegv/image/upload/t_media_lib_thumb/v1463990208/photo_dkkrxc.png" class="circle responsive-img" />
        ...
        <li id="dash_users">
            ...
            <ul>
                <li id="users_seller">
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Seller</a>
                </li>

                <li id="users_customer">
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Customer</a>
                </li>
            </ul>
            </div>
        </li>
        ...
        <li id="dash_products">
            ...
            <ul>
                ...
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Products</a>
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Orders</a>
                </li>
            </ul>
            </div>
        </li>
        ...
        <li id="dash_categories">
            ...
            <ul>
                ...
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Category</a>
                </li>

                <li id="categories_sub_category">
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Sub Category</a>
                </li>
            </ul>
            </div>
        </li>
        ...
        <li id="dash_brands">
            ...
            <ul>
                <li id="brands_brand">
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Brand</a>
                </li>

                <li id="brands_sub_brand">
                <a class="waves-effect" style={{ textDecoration: 'none' }} href="#!">Sub Brand</a>
                </li>
            </ul>
            </div>
        </li>
    ...
    <header>
        ...
        <div class="nav-wrapper">
            <a data-activates="slide-out" class="button-collapse show-on-" href="#!"><img style={{ marginTop: '17px', marginLeft: '5px' }} src="https://res.cloudinary.com/dacg0wegv/image/upload/t_media_lib_thumb/v1463989873/smaller-main-logo_3_bm40iv.gif" /></a>
        ...
        <div class="nav-wrapper indigo darken-2">
            <a style={{marginLeft: '20px'}} class="breadcrumb" href="#!">Admin</a>
            <a class="breadcrumb" href="#!">Index</a>

            <div style={{ marginRight: '20px' }} id="timestamp" class="right"></div>
        </div>
        </nav>
    </header>
